...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var eye = new FlxSprite().loadGraphic(Paths.image('eyeball', 'shared'));
		add(eye);
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.5).loadGraphic(Paths.image('eyeball'));
		add(ngSpr);
		ngSpr.visible = false;
		ngSpr.updateHitbox();
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['Vs Tenebris by']);
				// credTextShit.visible = true;
				case 3:
					addMoreText('Chxrlix', 15);
					addMoreText('EpicGamer', 15);
					addMoreText('Technically Insane', 15);
					addMoreText('Bonker34', 15);
					addMoreText('Honee', 15);
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['it is'], -40);
				case 7:
					addMoreText('watching', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
